...
const NAV_ITEMS = [
  ...
  { href: '#token',        icon: '$',  label: '$LUX Token' },
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-rh-border">
          ...
          <button
            onClick={() => setOpen(false)}
            className="lg:hidden text-rh-muted hover:text-gold transition-colors p-1"
          >
            <X size={18} />
          </button>
        </div>
        ...
        <div className="px-6 py-4 border-t border-rh-border">
          <div className="text-[10px] text-rh-faint tracking-wider">
            <div>© 2026 RoadHouse Syndicate</div>
            <a href="mailto:roadhousesyndicate@gmail.com" className="hover:text-gold transition-colors">
