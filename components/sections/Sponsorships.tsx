...
const PACKAGES = [
  {
    ...
    price: '$500',
    period: 'CAD / month',
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_SPONSOR_TB || 'price_REPLACE_SPONSOR_TRAIL',
    features: [
  ...
  },
  {
    ...
    price: '$1,500',
    period: 'CAD / month',
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_SPONSOR_FR || 'price_REPLACE_SPONSOR_FRONTIER',
    features: [
  ...
  },
  {
    ...
    price: '$5,000',
    period: 'CAD / month',
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_SPONSOR_PR || 'price_REPLACE_SPONSOR_PRAETOR',
    features: [
...
async function requestSponsorshipInvoice(packageName: string) {
  window.location.href = `mailto:roadhousesyndicate@gmail.com?subject=Sponsorship Inquiry — ${packageName}&body=Hi,%0A%0AI'm interested in the ${packageName} sponsorship package.%0A%0ACompany:%0AWebsite:%0AProduct/Service:%0AGoals:%0A%0AThanks`
}
