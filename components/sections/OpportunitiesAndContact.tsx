...
const ROLES = [
  ...
  },
  {
    ...
    apply: 'mailto:roadhousesyndicate@gmail.com',
...
export default function OpportunitiesAndContact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    window.location.href = `mailto:roadhousesyndicate@gmail.com?subject=${subject}&body=${body}`
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <div className="space-y-3 mb-8">
              {[
                { icon: '✉', label: 'Business Email', value: 'roadhousesyndicate@gmail.com', href: 'mailto:roadhousesyndicate@gmail.com' },
