        ...
        <div>
          <div className="bg-rh-card border border-rh-border rounded-lg p-8 card-glow mb-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a
                href="mailto:daltonellscheid@gmail.com"
          ...
          <div className="bg-rh-card border border-rh-border rounded-lg p-6 card-glow">
            ...
            <div className="space-y-3">
              {[
                ...
                { q: 'Stocking inquiries?', a: 'Send business and retail inquiries to daltonellscheid@gmail.com with your business info and location.' },
