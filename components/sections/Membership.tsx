...
const TIERS = [
  {
    ...
    priceId: process.env.NEXT_PUBLIC_STRIPE_SUB_REGULAR || 'price_REPLACE_SUB_REGULAR',
    features: [
  ...
  },
  {
    ...
    highlight: true,
    priceId: process.env.NEXT_PUBLIC_STRIPE_SUB_RANCH || 'price_REPLACE_SUB_RANCH',
    features: [
  ...
  },
  {
    ...
    priceId: process.env.NEXT_PUBLIC_STRIPE_SUB_PARTNER || 'price_REPLACE_SUB_PARTNER',
    features: [
      ...
      '2,000 $LUX governance tokens / mo',
    ],
    ...
    <section id="membership" className="px-8 lg:px-16 py-20 border-t border-rh-border">
      <div className="mb-10">
        ...
        <p className="text-rh-muted text-sm mt-3 max-w-xl tracking-wide">
          Access is earned through participation. Each tier unlocks governance rights, revenue-share allocation, and $LUX tokens.
      ...
      <p className="mt-6 text-[11px] text-rh-faint text-center tracking-wider">
        Recurring billing via Stripe · Cancel anytime in your member portal · $LUX tokens accrued monthly
      </p>
      ...
      <div className="mt-8 p-5 bg-rh-card border border-rh-border rounded-lg max-w-2xl mx-auto text-center">
        ...
        <p className="text-[12px] text-rh-muted leading-relaxed">
          Higher tiers (Steward at 10,000 $LUX · Praetor at 50,000 $LUX) are invitation-only — earned through demonstrated long-term commitment, not purchased.{' '}
