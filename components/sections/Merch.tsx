...
const MERCH = [
  {
    ...
    badge: 'Bestseller',
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_TEE || 'price_REPLACE_TEE',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
  },
  {
    id: 'rh-hat',
    ...
    badge: 'New',
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_HAT || 'price_REPLACE_HAT',
    sizes: ['One Size'],
  },
  {
    id: 'cc-hoodie',
    ...
    badge: 'Collab',
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_HOODIE || 'price_REPLACE_HOODIE',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
  },
  {
    id: 'sticker-pack',
    ...
    price: 1200,
    display: '$12 CAD',
    desc: '8-pack. Waterproof vinyl. RoadHouse · Coconut Cowboy · $LUX logos.',
    badge: null,
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_STICKERS || 'price_REPLACE_STICKERS',
    sizes: [],
  },
  {
    id: 'rh-glass',
    ...
    badge: 'Limited',
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_GLASS || 'price_REPLACE_GLASS',
    sizes: [],
  },
  {
    id: 'rh-phone',
    ...
    badge: null,
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_PHONE || 'price_REPLACE_PHONE',
