        ...
        <footer className="px-8 lg:px-16 py-12 border-t border-rh-border">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {[
                  { label: 'roadhousesyndicate@gmail.com', href: 'mailto:roadhousesyndicate@gmail.com' },
                  { label: 'daltonellscheid@gmail.com', href: 'mailto:daltonellscheid@gmail.com' },
